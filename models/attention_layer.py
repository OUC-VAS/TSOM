...
def multi_head_attention_forward(
    ...
    # convert ByteT
    # ensor key_padding_mask to bool
    ...
    if naive:
        ...
        attn_output_weights = attn_output_weights + gaussian[0].permute(2, 0, 1) * alpha
...
class GaussianMultiheadAttention(MultiheadAttention):
    ...
    def forward(self, query, key, value, key_padding_mask=None, need_weights=False, attn_mask=None, gaussian=None, alpha=None):
        r"""
    Args:
        query, key, value: map a query and a set of key-value pairs to an output.
            See "Attention Is All You Need" for more details.
    ...
    Shape:
        ...
        if not self._qkv_same_embed_dim:
            return multi_head_attention_forward(
                ...
                attn_mask=attn_mask, gaussian=gaussian, alpha=alpha)
        else:
            return multi_head_attention_forward(
                query, key, value, self.embed_dim, self.num_heads,
                self.in_proj_weight, self.in_proj_bias,
